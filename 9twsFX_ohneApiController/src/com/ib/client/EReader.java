...
public class EReader extends Thread {
    ...
    public EReader(EClientSocket parent, EReaderSignal signal) {
        ...
        System.err.println("EREADER ohne Sa wird verwendet! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    }
    
    public EReader(EClientSocket parent, EReaderSignal signal, ApiController ApiConn) {
    	m_clientSocket = parent;
        m_signal = signal;
        this.ApiConn = ApiConn;
        m_processMsgsDecoder = new EDecoder(parent.serverVersion(), ApiConn, parent);
//        ApiConn.tLine("EREADER mit ApiConn");
    }
...
//			}												
//    		System.out.println(" ***  (EReader) While  " + j + "\n"); // Wegmachen wieder ???  ----------------------  ???
    		msg = getMsg();
